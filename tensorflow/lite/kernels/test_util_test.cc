...
TEST(TestUtilTest, FloatingPointEqFp32) {
  ...
  // mininum, i.e. -126, this is the ULP used.
  ...
  // FP32 has 23 bits for tha fraction part, so the ULP error is between
  // 2^-23 / 2 and 2^-23 relative error. With rounding, almost 5 ULPs error
  // could possibly be considered as 4 ULPs. So the tolerated relative error of
  // 4 ULPs is roughly between 4 * 2^-23 / 2 and 5 * 2^-23 ~= 2.38 * 10^-7 and
  // 5.96 * 10-7.
  // 2 * 10^-7 relative error should be tolerated by 4 ULPs.
  ...
  // 6 * 10^-7 relative error should not be tolerated by 4 ULPs.
...
TEST(TestUtilTest, FloatingPointEqFp16) {
  ...
  // 0.39%.
  // 0.2% relative error should be tolerated by 4 ULPs in FP16.

...
func.func @sub_zero_quant(%arg0: tensor<32x!quant.uniform<u8:f32, 1.0>>) -> tensor<32x!quant.uniform<u8:f32, 1.0>> {
  %zero = arith.constant dense<0> : tensor<32x!quant.uniform<u8:f32, 1.0>>
...
func.func @mul_one_quant(%arg0: tensor<32x!quant.uniform<u8:f32, 1.0>>) -> tensor<32x!quant.uniform<u8:f32, 1.0>> {
  %one = arith.constant dense<1> : tensor<32x!quant.uniform<u8:f32, 1.0>>
...
func.func @add_zero_quant(%arg0: tensor<32x!quant.uniform<u8:f32, 1.0>>) -> tensor<32x!quant.uniform<u8:f32, 1.0>> {
  %one = arith.constant dense<0> : tensor<32x!quant.uniform<u8:f32, 1.0>>

  // CHECK: tfl.add
  // CHECK: return %0

  %0 = "tfl.add"(%one, %arg0) {fused_activation_function = "NONE"} : (tensor<32x!quant.uniform<u8:f32, 1.0>>, tensor<32x!quant.uniform<u8:f32, 1.0>>) -> tensor<32x!quant.uniform<u8:f32, 1.0>>
